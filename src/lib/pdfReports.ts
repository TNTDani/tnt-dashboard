...
export function generateScreeningReportHTML(
  ...
  const strengthsHTML = result.strengths
    .map(s => `<div class="list-item"><div class="dot" style="background:#4CAF50"></div><span>${s}</span></div>`)
    .join('');
...
<body>
  <div class="page">
    ...
    <div class="body">
      ...
      <div class="section">
        <div class="section-label" style="color:#4CAF50">Strengths</div>
        ${strengthsHTML}
      </div>` : ''}
...
<body>
  <div class="page">
    ...
    <div class="body">
      <div class="section" style="margin-bottom:8px">
        <p style="font-size:12px;color:#64748b">
          This guide was generated by the Orchard AI Screening Agent.
    ...
    <div class="footer">
      <span>${cv.firstName} — Interview Guide · Orchard</span>
      <span>${date}</span>
    </div>
  </div>
  <script>window.onload = () => { window.print(); }</script>
...
export function questionsToPlainText(
  ...
  lines.push('Orchard — Confidential');
