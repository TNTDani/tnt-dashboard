...
<body>
  <div class="page">
    <div class="header">
      <div class="header-logo">True North Talent</div>
    ...
    <div class="footer">
      <span>True North Talent — Confidential</span>
      <span>${date}</span>
    </div>
  </div>
...
<body>
  <div class="page">
    ...
    <div class="body">
      <div class="section" style="margin-bottom:8px">
        <p style="font-size:12px;color:#64748b">
          This guide was generated by the True North Talent AI Screening Agent.
    ...
    <div class="footer">
      <span>${cv.firstName} — Interview Guide · True North Talent</span>
      <span>${date}</span>
    </div>
  </div>
  <script>window.onload = () => { window.print(); }</script>
...
export function questionsToPlainText(
  ...
  const lines = [
    ...
    `Generated by True North Talent · ${date}`,
    '',
    '═'.repeat(60),
  ];
  ...
  lines.push('True North Talent — Confidential');
