...
import {
  ...
  X, Check, ChevronDown, ExternalLink, Briefcase,
} from 'lucide-react';
...
export default function ClientDetailPage() {
  ...
  useEffect(() => {
    if (client) {
      const vacancies = storage.getVacancies();
        ...
        <div className="xl:col-span-3 space-y-4">
          ...
          <div className="bg-[#0d1f3c] border border-[#1e3a5f] rounded-xl p-6">
            ...
            <p className="text-[#94a3b8] text-xs mb-3">
              {vacancyCount === 0 ? 'No vacancies linked to this client.' : `${vacancyCount} vacancies for ${client.companyName}`}
            </p>
            <Link
              href="/vacancies"
